...
const RAW: Record<string, string> = {
  ...
  "Improvised Orders": "Pendant la Phase d'Activation, après avoir pioché un pion Ordre dans votre réserve d'ordres, vous pouvez incliner cette carte (↱). Dans ce cas, piochez un second pion de cette réserve d'ordres et choisissez 1 des pions Ordre piochés à utiliser. Ensuite, remélangez l'autre pion Ordre dans votre réserve d'ordres. (Carte mise à jour : unique, elle ne se redresse plus automatiquement.)",
  ...
  "Captain Rex": "Unique, Soldat Clone uniquement. Ajoute 1 figurine du Capitaine Clone Rex (Chef). Cette unité augmente de 1 son courage et gagne 1 icône d'amélioration Personnel et 1 icône d'amélioration Ordonnance. Quand cette unité vainc une unité ennemie grâce à une attaque, après que l'action d'attaque a été résolue, elle peut effectuer 1 action gratuite.",
  ...
  "Trusted Agent": "Unique. Pendant l'étape « Donner des ordres » de la Phase de Commandement, vous pouvez supprimer cette carte de la partie (✖). Dans ce cas, choisissez une unité ▲ alliée : cette unité peut donner un ordre à l'unité choisie, quelle que soit son affiliation.",
  ...
  "Rebel Ambusher": "Ajoutez 1 figurine de Tireur Embusqué Rebelle. Cellule Dormante Rebelle uniquement. Action de carte (→) : si cette unité n'est pas engagée, choisissez une unité de soldats ennemie non engagée en LdV et lancez 1 dé d'attaque rouge : sur un résultat Touche ou Critique, l'unité choisie subit 1 blessure et gagne 1 pion Suppression.",
  ...
  "Proton Charge Saboteur": "Commandos Rebelles uniquement. Ajoutez 1 figurine de Saboteur avec Charge à Protons. Quand cette arme est ajoutée à une réserve d'attaque, les autres armes à distance de cette réserve gagnent Assaut 1. (Carte mise à jour, erratum 17/06/2026 : Déflagration, Impact 6.)",
  "Sonic Charge Saboteur": "Scout Troopers uniquement. Ajoutez 1 figurine de Saboteur avec Charge Sonique. Quand cette arme est ajoutée à une réserve d'attaque, les autres armes à distance de cette réserve gagnent Assaut 1. (Carte mise à jour, erratum 17/06/2026 : Déflagration, Impact 4, Suppressif.)",
  "boba fett infamous bounty hunter": "Erratum 17/06/2026 : le type d'unité de Boba Fett, Infâme Chasseur de Primes est Soldat Mandalorien.",
  "boba fett daimyo of mos espa": "Erratum 17/06/2026 : le type d'unité de Boba Fett, Daimyo de Mos Espa est Soldat Mandalorien.",
  "gar saxon militant commando": "Erratum 17/06/2026 : le type d'unité de Gar Saxon, Commandant Militant est Soldat Mandalorien.",
  "sabine wren": "Erratum 17/06/2026 : le type d'unité de Sabine Wren, Artiste Explosive est Soldat Mandalorien.",
  "mandalorian super commandos": "Erratum 17/06/2026 : le type d'unité de Super Commandos Mandaloriens est Soldat Mandalorien.",
};

...
const RAW: Record<string, string> = {
  ...
  // Lot Generic Upgrades FR.pdf (15/09) : visuels recadrés depuis les
  // grilles d'impression, vérifiés un par un contre le titre affiché.
  // Quand un visuel équivalent existait déjà (déposé par une autre session,
  // orphelin car jamais raccordé au catalogue), c'est lui qui est repris ici
  // plutôt qu'un nouveau recadrage redondant.
  'Vigilance': 'vigilance.jpg',
  'Lead by Example': 'lead-by-example.jpg',
  'Strict Orders': 'strict-orders.jpg',
  'Ascension Cables': 'cables-ascensionnels.jpg',
  ...
  // Cartes déjà nommées (cardNamesFr.ts) dont le visuel existait sans être
  // raccordé -- même lot de découverte que ci-dessus.

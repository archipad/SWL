...
const RAW: Record<string, CardDiceProfile> = {
  ...
  'Chewbacca': { weapons: [{ name: 'Prépotence', dice: [{ color: 'rouge', count: 4 }], range: 'melee', keywordIds: ['letal-x'] }, { name: 'Arbalète de Chewbacca', dice: [{ color: 'rouge', count: 2 }, { color: 'blanc', count: 2 }], range: '1-3', keywordIds: ['impact-x', 'perforant-x'] }], defenseColor: 'rouge' },
  ...
  'Fleet Troopers': { weapons: [{ name: 'Pistolet Blaster DH-17', dice: [{ color: 'blanc', count: 2 }], range: '1-2' }], defenseColor: 'rouge' },
  ...
  'Han Solo': { weapons: [{ name: 'Bagarre', dice: [{ color: 'blanc', count: 3 }], range: 'melee', keywordIds: [] }, { name: 'Blaster DL-44 de Han', dice: [{ color: 'rouge', count: 2 }], range: '1-2', keywordIds: ['perforant-x'] }], defenseColor: 'rouge' },
  ...
  'Jyn Erso': { weapons: [{ name: 'Tonfa Télescopique', dice: [{ color: 'noir', count: 4 }], range: 'melee', keywordIds: ['suppressif'] }, { name: 'Pistolet Blaster A-180', dice: [{ color: 'rouge', count: 2 }, { color: 'blanc', count: 1 }], range: '1-2', keywordIds: ['longue-distance', 'perforant-x'] }], defenseColor: 'rouge' },
  ...
  'Lando Calrissian': { weapons: [{ name: 'Plan de Secours', dice: [{ color: 'noir', count: 3 }], range: 'melee', keywordIds: [] }, { name: 'Blaster X-8 de Lando', dice: [{ color: 'rouge', count: 1 }, { color: 'noir', count: 3 }], range: '1-2', keywordIds: ['longue-distance'] }], defenseColor: 'rouge' },
  ...
  'Mark II Medium Blaster Trooper': { weapons: [{ name: 'Non armé', dice: [{ color: 'blanc', count: 1 }], range: 'melee', keywordIds: [] }, { name: 'Blaster Moyen Mark II', dice: [{ color: 'noir', count: 4 }], range: '1-3', keywordIds: ['critique-x', 'encombrant', 'fixe'] }], defenseColor: 'rouge' },
  ...
  'Tauntaun Riders': { weapons: [{ name: 'Cavalcade', dice: [{ color: 'blanc', count: 1 }, { color: 'noir', count: 2 }], range: 'melee', keywordIds: ['belier-x'] }, { name: 'Pistolets Blaster', dice: [{ color: 'rouge', count: 2 }], range: '1-2', keywordIds: [] }], defenseColor: 'rouge' },

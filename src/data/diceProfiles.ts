...
const RAW: Record<string, CardDiceProfile> = {
  ...
  'Major Marquand': { weapons: [{ name: 'Lance-grenades', dice: [{ color: 'noir', count: 2 }], range: '-2', keywordIds: ['fixe', 'deflagration'] }, { name: 'Blasters Légers Jumelés 88', dice: [{ color: 'rouge', count: 1 }, { color: 'blanc', count: 1 }, { color: 'noir', count: 1 }], range: '-3', keywordIds: ['fixe', 'impact-x'], keywordValues: { 'impact-x': 1 } }, { name: 'Blasters Jumelés MS-4', dice: [{ color: 'rouge', count: 2 }, { color: 'blanc', count: 2 }, { color: 'noir', count: 2 }], range: '1-4', keywordIds: ['fixe', 'impact-x'], keywordValues: { 'impact-x': 3 } }], defenseColor: 'rouge' },

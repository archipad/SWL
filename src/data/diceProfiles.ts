...
const RAW: Record<string, CardDiceProfile> = {
  ...
  'Battle Shield Wookiee': { weapons: [{ name: 'Bouclier de Combat', dice: [{ color: 'blanc', count: 2 }], range: 'melee' }] },
  ...
  'Cassian Andor': { weapons: [{ name: 'Arts Martiaux', dice: [{ color: 'blanc', count: 3 }], range: 'melee' }, { name: 'Blaster Modulaire de Cassian', dice: [{ color: 'blanc', count: 2 }, { color: 'noir', count: 2 }], range: '1-2' }], defenseColor: 'rouge' },
  'Chewbacca': { weapons: [{ name: 'Prépotence', dice: [{ color: 'rouge', count: 4 }], range: 'melee' }, { name: 'Arbalète de Chewbacca', dice: [{ color: 'rouge', count: 2 }, { color: 'noir', count: 2 }], range: '1-3' }], defenseColor: 'rouge' },
  ...
  'DLT-19x Sniper': { weapons: [{ name: 'Fusil DLT-19x', dice: [{ color: 'rouge', count: 2 }], range: '1-5' }] },
  ...
  'DW-3 Concussion Grenade Launcher': { weapons: [{ name: 'Lance-grenades DW-3', dice: [{ color: 'blanc', count: 2 }], range: '1-2' }] },
  'Dark Trooper Squad': { weapons: [{ name: 'Poing Écrasant', dice: [{ color: 'rouge', count: 1 }, { color: 'blanc', count: 1 }], range: 'melee' }, { name: 'Blaster E-11D', dice: [{ color: 'blanc', count: 1 }], range: '1-3' }], defenseColor: 'rouge' },
  ...
  'Director Orson Krennic': { weapons: [{ name: 'Non armé', dice: [{ color: 'blanc', count: 1 }], range: 'melee' }, { name: 'Blaster de Krennic', dice: [{ color: 'rouge', count: 3 }], range: '1-2' }], defenseColor: 'rouge' },
  ...
  'Flametrooper': { weapons: [{ name: 'Lance-flammes', dice: [{ color: 'blanc', count: 1 }], range: '-1' }] },
  ...
  'General Veers': { weapons: [{ name: 'Expertise du Combat', dice: [{ color: 'blanc', count: 2 }], range: 'melee' }, { name: 'Fusil Blaster de Veers', dice: [{ color: 'rouge', count: 3 }], range: '1-3' }], defenseColor: 'rouge' },
  'HH-12 Stormtrooper': { weapons: [{ name: 'Lance-roquettes HH-12', dice: [{ color: 'blanc', count: 3 }], range: '2-4' }] },
  ...
  'Iden Versio': { weapons: [{ name: 'Arts Martiaux', dice: [{ color: 'rouge', count: 3 }], range: 'melee' }, { name: 'Fusil DLT-20A d\'Iden', dice: [{ color: 'blanc', count: 2 }], range: '1-#' }, { name: 'Répétiteur TL-50 d\'Iden', dice: [{ color: 'rouge', count: 2 }, { color: 'blanc', count: 2 }, { color: 'noir', count: 1 }], range: '1-3' }], defenseColor: 'rouge' },
  ...
  'Imperial Special Forces': { weapons: [{ name: 'Non armé', dice: [{ color: 'rouge', count: 1 }], range: 'melee' }, { name: 'Fusil Blaster E-11', dice: [{ color: 'blanc', count: 1 }], range: '1-3' }], defenseColor: 'rouge' },
  'Imperial Special Forces Inferno Squad': { weapons: [{ name: 'Combat Rapproché', dice: [{ color: 'rouge', count: 1 }], range: 'melee' }, { name: 'Fusil Blaster E-11', dice: [{ color: 'blanc', count: 2 }], range: '1-3' }], defenseColor: 'rouge' },
  'Jetpack Rockets': { weapons: [{ name: 'Roquettes Dorsales', dice: [{ color: 'rouge', count: 1 }], range: '3-4' }] },
  'Jyn Erso': { weapons: [{ name: 'Tonfa Télescopique', dice: [{ color: 'blanc', count: 4 }], range: 'melee' }, { name: 'Pistolet Blaster A-180', dice: [{ color: 'rouge', count: 2 }, { color: 'blanc', count: 1 }], range: '1-2' }], defenseColor: 'rouge' },
  ...
  'Lando Calrissian': { weapons: [{ name: 'Plan de Secours', dice: [{ color: 'blanc', count: 3 }], range: 'melee' }, { name: 'Blaster X-8 de Lando', dice: [{ color: 'rouge', count: 1 }, { color: 'noir', count: 3 }], range: '1-2' }], defenseColor: 'rouge' },
  'Leia Organa': { weapons: [{ name: 'Arts Martiaux', dice: [{ color: 'blanc', count: 3 }], range: 'melee' }, { name: 'Blaster de Leia', dice: [{ color: 'rouge', count: 3 }], range: '1-3' }], defenseColor: 'rouge' },
  ...
  'Luke Skywalker Jedi Knight': { weapons: [{ name: 'Sabre Laser de Luke', dice: [{ color: 'blanc', count: 7 }], range: 'melee' }], defenseColor: 'rouge' },
  'M-45 Ion Blaster': { weapons: [{ name: 'Blaster Ionique M-45', dice: [{ color: 'blanc', count: 2 }, { color: 'noir', count: 2 }], range: '1-4' }] },
  'MPL-57 Barrage Trooper': { weapons: [{ name: 'MPL-57 de Barrage', dice: [{ color: 'rouge', count: 2 }, { color: 'noir', count: 1 }], range: '1-3' }] },
  ...
  'Mandalorian Resistance': { weapons: [{ name: 'Blasters WESTAR-35', dice: [{ color: 'blanc', count: 2 }], range: '-2' }], defenseColor: 'rouge' },
  'Mark II Medium Blaster Trooper': { weapons: [{ name: 'Non armé', dice: [{ color: 'blanc', count: 1 }], range: 'melee' }, { name: 'Blaster Moyen Mark II', dice: [{ color: 'blanc', count: 4 }], range: '1-3' }], defenseColor: 'rouge' },
  ...
  'Rebel Commandos': { weapons: [{ name: 'Non armé', dice: [{ color: 'blanc', count: 1 }], range: 'melee' }, { name: 'Fusil Blaster A280', dice: [{ color: 'blanc', count: 1 }], range: '1-3' }], defenseColor: 'rouge' },
  'Rebel Commandos Strike Team': { weapons: [{ name: 'Non armé', dice: [{ color: 'blanc', count: 1 }], range: 'melee' }, { name: 'Fusil Blaster A280', dice: [{ color: 'blanc', count: 1 }], range: '1-3' }], defenseColor: 'rouge' },
  ...
  'Rebel Troopers': { weapons: [{ name: 'Non armé', dice: [{ color: 'blanc', count: 1 }], range: 'melee' }, { name: 'Fusil Blaster A280', dice: [{ color: 'blanc', count: 1 }], range: '1-3' }], defenseColor: 'rouge' },
  'Rebel Veteran Squad': { weapons: [], note: 'règle de cohésion, pas d\'arme' },
  'Rebel Veterans': { weapons: [{ name: 'Non armé', dice: [{ color: 'blanc', count: 1 }], range: 'melee' }, { name: 'Fusil Blaster A280', dice: [{ color: 'blanc', count: 1 }], range: '1-3' }], defenseColor: 'rouge' },
  ...
  'Tauntaun Riders': { weapons: [{ name: 'Cavalcade', dice: [{ color: 'blanc', count: 1 }, { color: 'rouge', count: 2 }], range: 'melee' }, { name: 'Pistolets Blaster', dice: [{ color: 'rouge', count: 2 }], range: '1-2' }], defenseColor: 'rouge' },
  'The Darksaber': { weapons: [{ name: 'Le Sabre Noir', dice: [{ color: 'rouge', count: 5 }], range: 'melee' }] },
  'The Fifth Brother': { weapons: [{ name: 'Sabre Laser Rotatif', dice: [{ color: 'rouge', count: 5 }], range: 'melee' }, { name: 'Sabre Laser Lancé', dice: [{ color: 'rouge', count: 3 }], range: '1-2' }], defenseColor: 'rouge' },
  'The Seventh Sister': { weapons: [{ name: 'Sabre Laser Rotatif', dice: [{ color: 'rouge', count: 5 }], range: 'melee' }, { name: 'Sabre Laser Lancé', dice: [{ color: 'rouge', count: 3 }], range: '1-2' }], defenseColor: 'rouge' },
  'Tristan Wren': { weapons: [{ name: 'Blaster de Tristan', dice: [{ color: 'blanc', count: 2 }], range: '1-3' }] },
  ...
  'Wookiee Warriors Freedom Fighters': { weapons: [{ name: 'Poignard Ryyk', dice: [{ color: 'blanc', count: 2 }], range: 'melee' }, { name: 'Pistolet Kashyyyk', dice: [{ color: 'blanc', count: 1 }, { color: 'noir', count: 1 }], range: '1-2' }], defenseColor: 'rouge' },

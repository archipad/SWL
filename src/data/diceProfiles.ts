...
const RAW: Record<string, CardDiceProfile> = {
  ...
  'Major Marquand': { weapons: [{ name: 'Lance-grenades', dice: [{ color: 'noir', count: 2 }], range: '1-2', keywordIds: ['fixe', 'deflagration'] }, { name: 'Blasters Légers Jumelés 88', dice: [{ color: 'rouge', count: 1 }, { color: 'blanc', count: 1 }, { color: 'noir', count: 1 }], range: '1-3', keywordIds: ['fixe', 'impact-x'], keywordValues: { 'impact-x': 1 } }, { name: 'Blasters Jumelés MS-4', dice: [{ color: 'rouge', count: 2 }, { color: 'blanc', count: 2 }, { color: 'noir', count: 2 }], range: '1-4', keywordIds: ['fixe', 'impact-x'], keywordValues: { 'impact-x': 3 } }], defenseColor: 'rouge' },
  ...
  'Sabine Wren': { weapons: [{ name: 'Blasters WESTAR-35', dice: [{ color: 'rouge', count: 1 }, { color: 'blanc', count: 1 }, { color: 'noir', count: 1 }], range: '1-2' }], defenseColor: 'rouge' },
  'Scatter Gun Trooper': { weapons: [{ name: 'Fusil à Dispersion', dice: [{ color: 'rouge', count: 2 }], range: '1-2' }] },
  ...
  'Kallus the Operative': { weapons: [{ name: 'Fusil-Bo J-19', dice: [{ color: 'blanc', count: 1 }, { color: 'noir', count: 2 }], range: 'melee-2', keywordIds: ['longue-distance'], verifiedAgainstCard: true, verificationSource: 'Relu sur le visuel français (21/09/2026, audit des armes manquantes), à confirmer dans l\'écran de certification' }] },
  ...
  'Ursa Wren': { weapons: [{ name: 'Blaster d\'Ursa', dice: [{ color: 'rouge', count: 1 }, { color: 'blanc', count: 1 }, { color: 'noir', count: 1 }], range: '1-2' }] },

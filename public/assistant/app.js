...
const codexPortraits={'darth vader dark lord of the sith':'darth-vader','stormtroopers':'stormtroopers','scout troopers':'scout-troopers','at st':'at-st','imperial officer':'imperial-officer','rebel troopers':'rebel-troopers','luke skywalker':'luke-skywalker','rebel commandos strike team':'rebel-commandos','rebel commandos':'rebel-commandos','at rt':'at-rt','rebel officer':'rebel-officer'};
const tilePortrait=name=>codexPortraits[norm(name)]?`../codex/portraits/${codexPortraits[norm(name)]}.png`:'';

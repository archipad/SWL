...
const ATTACK_CARD_FX=[
  ...
  {id:'captain-rex',card:'captain rex',side:'attacker',steps:[5],needsWounds:true,info:true,title:'CAPITAINE CLONE REX',text:'Si cette unité vainc une unité ennemie grâce à cette attaque : après que l’action d’attaque a été résolue, elle peut effectuer 1 action gratuite.'},

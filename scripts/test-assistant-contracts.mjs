...
assert.match(index, /unit-screen\.css\?v=10/, 'La feuille de mise en page de l’écran d’unité doit être chargée')
...
assert.match(index, /app\.js\?v=131/, 'Le verrou de navigation de la certification doit invalider le cache JavaScript')

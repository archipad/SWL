...
assert.match(index, /unit-screen\.css\?v=15/, 'La feuille de mise en page de l’écran d’unité doit être chargée')
...
assert.match(index, /app\.js\?v=138/, 'Le verrou de navigation de la certification doit invalider le cache JavaScript')
...
assert.match(index, /certification\.js\?v=80/, 'La certification V2 doit invalider le cache de son interface')

...
assert.match(index, /unit-screen\.css\?v=12/, 'La feuille de mise en page de l’écran d’unité doit être chargée')
...
assert.match(index, /app\.js\?v=135/, 'Le verrou de navigation de la certification doit invalider le cache JavaScript')

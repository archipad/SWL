...
assert.match(index, /app\.js\?v=123/, 'Le verrou de navigation de la certification doit invalider le cache JavaScript')
...
assert.match(index, /style\.css\?v=87/, 'La certification complète doit invalider le cache CSS')
...
assert.match(index, /certification\.js\?v=77/, 'La certification V2 doit invalider le cache de son interface')

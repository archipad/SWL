...
assert.match(index, /resolver-polish\.css\?v=29/, 'La feuille d’harmonisation des écrans de résolution doit être chargée')
...
assert.match(index, /unit-screen\.css\?v=14/, 'La feuille de mise en page de l’écran d’unité doit être chargée')
...
assert.match(index, /app\.js\?v=137/, 'Le verrou de navigation de la certification doit invalider le cache JavaScript')
...
assert.match(index, /certification\.js\?v=79/, 'La certification V2 doit invalider le cache de son interface')
